...
otherwise statement will be an empty string because i do not want to have text saying 'no nested comments' on the page. 
...
export default function Comment(comment) {
    //   console.log(comment) 
      const hasNestedComments = comment.comments.length > 0 //checking for nested comments. 
